...
/*   Updated: 2024/11/30 02:16:36 by hdazia           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
    *line = ft_substr(*storing, 0, palce_nline + 1);
    *storing = ft_stored_string(storing, palce_nline + 1);
    return (*line);
}
char *ft_stored_string(char **str, int palce_nline)
{
    ...
    remeber = ft_substr(*str, palce_nline, len_str);
    free(*str);
    *str = NULL;
    return (remeber);
}
